(function (e) {
    function t(t) {
        for (var l, u, i = t[0], n = t[1], o = t[2], c = 0, p = []; c < i.length; c++) u = i[c], Object.prototype.hasOwnProperty.call(s, u) && s[u] && p.push(s[u][0]), s[u] = 0;
    ...
    function a() {
        for (var e, t = 0; t < r.length; t++) {
            for (var a = r[t], l = !0, i = 1; i < a.length; i++) {
                var n = a[i];
                0 !== s[n] && (l = !1)
            }
    ...
    u.m = e, u.c = l, u.d = function (e, t, a) {
        ...
        if (u.r(a), Object.defineProperty(a, "default", {
            enumerable: !0,
            value: e
        }), 2 & t && "string" != typeof e) for (var l in e) u.d(a, l, function (t) {
            return e[t]
        }.bind(null, l));
        return a
    }, u.n = function (e) {
    ...
    0: function (e, t, a) {
        ...
        e.exports = [{
            ...
            title: "html注释",
            rule: /^<!--[\s\S]*?-->$/,
            examples: ['\x3c!--<div class="_bubble"></div>--\x3e']
        }, {
            title: "md5格式(32位)",
            ...
            examples: ["正则", "前端"]
        }, {title: "小数", rule: /^\d+\.\d+$/, examples: ["0.0", "0.09"]}, {
            title: "数字",
            rule: /^\d{1,}$/,
            examples: [12345678]
        }, {
        ...
        }, {title: "qq号格式正确", rule: /^[1-9][0-9]{4,10}$/, examples: [903013545, 9020304]}, {
            title: "数字和字母组成",
            rule: /^[A-Za-z0-9]+$/,
            examples: ["james666", "haha233hi"]
        }, {title: "英文字母", rule: /^[a-zA-Z]+$/, examples: ["Russel"]}, {
            title: "小写英文字母组成",
            rule: /^[a-z]+$/,
            examples: ["russel"]
        }, {
            ...
            examples: ["哈哈哈", "你好6啊"]
        }, {title: "不能包含字母", rule: /^[^A-Za-z]*$/, examples: ["你好6啊", "@¥()！"]}, {
            title: "java包名",
            ...
            rule: /^(?=.*[a-zA-Z])(?=.*\d).+$/,
            examples: ["我a我1我", "a对1"]
        }, {title: "香港身份证 ", rule: /^[a-zA-Z]\d{6}\([\dA]\)$/, examples: ["K034169(1)"]}, {
            title: "澳门身份证 ",
            rule: /^[1|5|7]\d{6}[(\d)]{3}$/,
            examples: ["5686611(1)"]
        }, {title: "台湾身份证 ", rule: /^[a-zA-Z][0-9]{9}$/, examples: ["U193683453"]}]
    }, "56d7": function (e, t, a) {
        "use strict";
        a.r(t);
        a("cadf"), a("551c"), a("f751"), a("097d");
        var l = a("2b0e"), s = function () {
            var e = this, t = e.$createElement, a = e._self._c || t;
            return a("main", [a("article", {staticClass: "fixed"}, [a("a", {
                staticClass: "message",
                attrs: {
                ...
                attrs: {height: "24", width: "24", viewBox: "0 0 16 16", version: "1.1", "aria-hidden": "true"}
            }, [a("path", {
                attrs: {
                    "fill-rule": "evenodd",
                    fill: "#fff",
                ...
                directives: [{name: "model", rawName: "v-model", value: e.keyword, expression: "keyword"}],
                ref: "searchInput",
                staticClass: "search-input",
                attrs: {autofocus: "", placeholder: "搜索关键词, 如'手机'", type: "text"},
                domProps: {value: e.keyword},
                on: {
                    keyup: e.search,
                    mouseenter: e.selectSearchInputText,
                    focus: e.selectSearchInputText,
                    input: function (t) {
                        t.target.composing || (e.keyword = t.target.value)
                    }
                }
            })]), a("article", [0 < e.rules.length ? a("ul", {staticClass: "list"}, e._l(e.rules, (function (t, l) {
                var s = t.title, r = t.rule, u = (t.events, t.examples), i = t.counterExamples;
                return a("li", {
                    key: s, staticClass: "row", on: {
                        mouseenter: function (t) {
                            return e.mouseenterHandler(l)
                        }
                    }
                }, [a("i", {staticClass: "border"}), a("h2", [e._v(e._s(s))]), a("p", {staticClass: "rule"}, [a("span", {
                    staticClass: "btn-copy",
                    attrs: {"data-clipboard-text": r}
                }, [e._v("点击复制")]), a("a", {
                    staticClass: "btn-better",
                    attrs: {href: "https://github.com/any86/any-rule/issues/new?title=我有更好的正则: " + s, target: "_blank"}
                }, [e._v("我有更好的正则")]), a("code", {
                    ref: "code",
                    refInFor: !0,
                    staticClass: "javascript"
                }, [e._v(e._s(r))])]), a("section", {staticClass: "verification"}, [a("label", [a("input", {
                    directives: [{
                        name: "model",
                        rawName: "v-model",
                        value: e.list[l].value,
                        expression: "list[index].value"
                    }],
                    key: s,
                    ref: "input",
                    refInFor: !0,
                    attrs: {placeholder: e.parseExample(u, i)},
                    domProps: {value: e.list[l].value},
                    on: {
                        compositionstart: function (t) {
                            return e.check(l, "blur")
                            ...
                            return e.check(l, "keyup")
                        }, input: function (t) {
                            t.target.composing || e.$set(e.list[l], "value", t.target.value)
                        }
                    }
                }), a("span", {
                    staticClass: "btn-clear", on: {
                        click: function (t) {
                            return e.reset(l)
                        }
                    }
                }, [e._v("清空")])]), a("div", {staticClass: "tip"}, [void 0 !== e.list[l].isOk ? [e.list[l].isOk ? a("p", {staticClass: "success"}, [e._v("通过")]) : a("p", {staticClass: "error"}, [e._v("不通过")])] : e._e()], 2)]), a("section", {staticClass: "trigger"}, [a("h3", [e._v("验证时机")]), a("label", [a("input", {
                    directives: [{
                        name: "model",
                        rawName: "v-model",
                        value: e.list[l].events.blur,
                        expression: "list[index].events.blur"
                    }],
                    attrs: {type: "checkbox"},
                    domProps: {checked: Array.isArray(e.list[l].events.blur) ? e._i(e.list[l].events.blur, null) > -1 : e.list[l].events.blur},
                    on: {
                        change: function (t) {
                            var a = e.list[l].events.blur, s = t.target, r = !!s.checked;
                            if (Array.isArray(a)) {
                                var u = null, i = e._i(a, u);
                                s.checked ? i < 0 && e.$set(e.list[l].events, "blur", a.concat([u])) : i > -1 && e.$set(e.list[l].events, "blur", a.slice(0, i).concat(a.slice(i + 1)))
                            } else e.$set(e.list[l].events, "blur", r)
                        }
                    }
                }), e._v(" blur ")]), a("label", [a("input", {
                    directives: [{
                        name: "model",
                        rawName: "v-model",
                        value: e.list[l].events.keyup,
                        expression: "list[index].events.keyup"
                    }],
                    attrs: {type: "checkbox"},
                    domProps: {checked: Array.isArray(e.list[l].events.keyup) ? e._i(e.list[l].events.keyup, null) > -1 : e.list[l].events.keyup},
                    on: {
                        change: function (t) {
                            var a = e.list[l].events.keyup, s = t.target, r = !!s.checked;
                            if (Array.isArray(a)) {
                                var u = null, i = e._i(a, u);
                                s.checked ? i < 0 && e.$set(e.list[l].events, "keyup", a.concat([u])) : i > -1 && e.$set(e.list[l].events, "keyup", a.slice(0, i).concat(a.slice(i + 1)))
                            } else e.$set(e.list[l].events, "keyup", r)
                        }
                    }
                }), e._v(" keyup ")])])])
            })), 0) : a("p", {attrs: {align: "center"}}, [e._v("无数据")])])])
        }, r = [function () {
            var e = this, t = e.$createElement, a = e._self._c || t;
            return a("a", {
                staticClass: "github",
        ...
        }], u = (a("0d6d"), a("46e9")), i = a.n(u), n = a("b311"), o = a.n(n), d = {
            name: "app", components: {}, data: function () {
                return Object.freeze(i.a), {
                    token: "",
                    timer: null,
                    keyword: "",
                    rules: i.a,
                    list: i.a.map((function () {
                        return {value: "", isOk: void 0, events: {blur: !0, keyup: !0}}
                    }))
                }
            }, mounted: function () {
                var e = new o.a(".btn-copy");
                ...
                e.on("success", (function (e) {
                    clearTimeout(t);
                    var a = e.trigger;
                    a.classList.contains("success") && a.classList.remove("success"), a.classList.add("success"), t = setTimeout((function () {
                        a.classList.remove("success")
                    }), 1e3)
                }))
            }, methods: {
                parseExample: function (e, t) {
                    var a = ["例如: ".concat(e.join(", "))];
                    return void 0 !== t && a.push("反例: ".concat(t.join(", "))), a.join(" , ")
                }, search: function () {
                    var e = this;
                    "" !== this.keyword ? this.rules = this.rules.filter((function (t) {
                        var a = t.title;
                        return -1 !== a.toLowerCase().indexOf(e.keyword.toLowerCase())
                    })) : this.rules = i.a, _hmt.push(["_trackEvent", "交互", "搜索", "关键词", this.keyword])
                    ...
                    this.$nextTick((function () {
                        t.list[e].value = "", t.list[e].isOk = void 0
                    }))
                }, check: function (e, t) {
                    var a = this.list[e], l = a.events, s = a.value;
                    if ("" === s && this.reset(e), l[t]) {
                        var r = this.rules[e].rule, u = this.list[e];
                        u.isOk = r.test(u.value)
                    }
                    "blur" === t && _hmt.push(["_trackEvent", "input框", this.rules[e].title, this.list[e].value])
                }
            }
        }, c = d, p = (a("86ff"), a("2877")), f = Object(p["a"])(c, s, r, !1, null, "4cd1b5e3", null), m = f.exports;
        l["a"].config.productionTip = !1, "serviceWorker" in navigator && window.addEventListener("load", (function () {
        ...
        "use strict";
        var l = a("a6bd"), s = a.n(l);
        s.a
    }, a6bd: function (e, t, a) {
    }
});
//# sourceMappingURL=app.6e4e98be.js.map